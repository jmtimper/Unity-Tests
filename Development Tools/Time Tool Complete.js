...
var fromLoadTime   		: float 	= 0.0;				// use to store original load time
...
function Update ()
{
	aniSprite ( aniFont1, 10, 1, 0, 0, 10, "font1" );	// animated font sprite - type: font1
	aniSprite ( aniFont2, 10, 1, 0, 0, 10, "font2" );	// animated font sprite - type: font2
	aniSprite ( aniFont3, 10, 1, 0, 0, 10, "font3" );	// animated font sprite - type: font3	
	aniSprite ( aniFont4, 10, 1, 0, 0, 10, "font4" );	// animated font sprite - type: font4
...
function OnGUI ()                            							// print time variables to the screen (gui)
{
	...
	GUI.skin = marioGui;	// Print current Play Time to the screen with a Gui skin (font from Mario Bros)
